...
<section class="projects">
    ...
    <h1 class="heading">Latest benefactors.</h1>
    ...
    if ($select_benefactor->rowCount() > 0) {
        while ($fetch_project = $select_benefactor->fetch(PDO::FETCH_ASSOC)) {
    ?>
    <form action="" method="post" class="box">
        ...
        <a href="benefactor_view.php?pid=<?= $fetch_project['id']; ?>" class="fas fa-eye"></a>
    ...
    <?php
        ...
        echo '<p class="empty">No benefactor found!</p>';
    }
    ?>
