...
<section class="projects">
    ...
    <h1 class="heading">Latest zakah.</h1>
    ...
    if ($select_zaka->rowCount() > 0) {
        while ($fetch_project = $select_zaka->fetch(PDO::FETCH_ASSOC)) {
    ?>
    <form action="" method="post" class="box">
        ...
        <a href="zaka_view.php?pid=<?= $fetch_project['id']; ?>" class="fas fa-eye"></a>
    ...
    <?php
        ...
        echo '<p class="empty">No zaka found!</p>';
    }
    ?>
